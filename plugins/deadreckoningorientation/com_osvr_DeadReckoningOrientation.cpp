/** @file
    @brief Wrapper for a vrpn_Tracker_DeadReckoningOrientation
...
#include "com_osvr_DeadReckoningOrientation_json.h"
  ...
  public:
    AnalogSyncDevice(OSVR_PluginRegContext ctx) : m_myVal(0) {
        ...
        m_dev.sendJsonDescriptor(
            com_osvr_DeadReckoningOrientation_json);
...
OSVR_PLUGIN(com_osvr_DeadReckoningOrientation) {
