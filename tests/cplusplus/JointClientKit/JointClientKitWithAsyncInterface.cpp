...
static void
myEyeTracker2DCallback(void *userdata, const OSVR_TimeValue *timestamp,
...
TEST(BasicJointClientKitWithInterface, ConstructDestruct) {
    ...
    ASSERT_EQ(OSVR_RETURN_SUCCESS, osvrJointClientOptionsLoadPlugin(
                                       options, "com_osvr_example_EyeTracker"));
    ...
    ASSERT_EQ(OSVR_RETURN_SUCCESS, osvrRegisterEyeTracker2DCallback(
                                       eye, &myEyeTracker2DCallback, nullptr));
